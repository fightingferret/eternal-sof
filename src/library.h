...
cfunc code_can_fly;
cfunc code_can_move;
cfunc code_can_see;             // Added by Sphen (Sept 6, 00)
...
cfunc code_dam_message_acid;    // Added by Sphen (Sept 6, 00)    
cfunc code_dam_message_cold;    // Added by Sphen (Sept 6, 00)    
cfunc code_dam_message_fire;    // Added by Sphen (Sept 6, 00)    
cfunc code_dam_message_shock;   // Added by Sphen (Sept 6, 00)    
cfunc code_deinvis;             // Added by Sphen (Sept 6, 00)    
cfunc code_dice;
cfunc code_disarm;
cfunc code_do_spell;
...
cfunc code_get_name;
cfunc code_get_pos;     // Added by Sphen (Sept 6, 00)
cfunc code_get_reputation;  // Added Rengeleif 10-5-00 //
cfunc code_get_room;
cfunc code_get_time;
...
cfunc code_has_obj_inv;
cfunc code_has_obj_worn;
...
cfunc code_is_affected;     // Added by Sphen (Sept 6, 00)    
cfunc code_is_camouflaged;  // Added by Sphen (Sept 6, 00)    
cfunc code_is_invis;        // Added by Sphen (Sept 6, 00)    
cfunc code_is_exhausted;
cfunc code_is_locked;
cfunc code_is_fighting;
cfunc code_is_follower;
cfunc code_modify_rep;      // Added by Sphen (Sept 6, 00)    
...
cfunc code_obj_type;        // Added by Sphen (Sept 6, 00)    
...
cfunc code_remove_aff;    // Added by Sphen (Sept 6, 00)    
cfunc code_remove_cflag;
cfunc code_remove_rflag;
cfunc code_reputation;
cfunc code_rflag;
cfunc code_sacrifice;
cfunc code_sees_hidden;   // Added by Sphen (Sept 6, 00)    
cfunc code_sees_invis;    // Added by Sphen (Sept 6, 00)    
...
cfunc code_set_mp;
cfunc code_set_mv;
cfunc code_set_pos;       // Added by Sphen (Sept 6, 00)    
...
cfunc code_uncamouflage; // Added by Sphen (Sept 6, 00)    
cfunc code_unhide;       // Added by Sphen (Sept 6, 00)    
cfunc code_unlock;
cfunc code_update_quest;
cfunc code_use_move;     // Added by Sphen (Sept 6, 00)
cfunc code_wait;
