...
#define IFLAG_CANGROUP              0
#define IFLAG_AUCTION               1
#define IFLAG_BOUNTY                2
#define IFLAG_BUGS                  3
#define IFLAG_CLANS                 4
#define IFLAG_DEATHS                5
#define IFLAG_LEVELS                6 
#define IFLAG_LOGINS                7
#define IFLAG_NOTES                 8
#define IFLAG_REQUESTS              9
#define IFLAG_WRITES                10
#define IFLAG_AFK                   11
#define MAX_IFLAG                   12
...
#define PLR_CONTINUOUS              2
#define PLR_FIFO_ORDERING           3
#define PLR_NEWS                    4
...
#define PLR_CODECHAN               55
#define PLR_SHOW_NO_SHOW           56
#define MAX_PLR                    57
