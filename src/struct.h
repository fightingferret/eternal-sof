...
typedef class   Pet_Data           pet_data;
...
td bool         spell_func  ( cd*, char_data*, void*, int, int, int );
...
#include "descdata.h"  /* PUIOK 14/3/2000 */
...
do_func do_qflag;
do_func do_typolist;
do_func do_newbiechan;
do_func do_csocial;
do_func do_clipboard;
do_func do_gamestat;
do_func do_news;
do_func do_idletime;
do_func do_settitle;
do_func do_ansi; /* TEMPORARY */
do_func do_icq;
do_func do_codechan;
do_func do_compile;
do_func do_newareas;
...
do_func do_mpstat;
do_func do_mreset;
do_func do_mdelrange;
do_func do_mset;
do_func do_msetrange;
do_func do_mstat;
do_func do_mwhere;
do_func do_name;
do_func do_noemote;
...
/*  PUIOK 15/5/2000  */
bool   start_burning      ( obj_data*&, bool, int = 1 );
bool   stop_burning       ( obj_data*&, int = 1 );
...
CD     *rand_player       ( room_data*, int = 1, int = 0, int = 0 );
...
void   get_obj            ( char_data*, thing_array*, obj_data* );
