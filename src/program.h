...
#define MPROG_TRIGGER_RANDOM         13
#define MPROG_TRIGGER_RANDOM_ALWAYS  14
#define MPROG_TRIGGER_TIME           15
#define MAX_MPROG_TRIGGER            16
...
bool oflag_is_set( oprog_data*, const char* );  /* PUIOK 9/2/2000 */
