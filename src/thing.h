...
obj_data*    sunder             ( obj_data*, int = 1 );
void         select             ( thing_array& );
void         select             ( thing_array&, char_data*, bool = FALSE );
...
char* one_extra_desc   ( extra_array*, char* );  /* PUIOK 21/1/2000 */
