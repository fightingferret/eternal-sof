...
/* Trade defines?  Unknown what these are atm */
...
/* Categories of skills. {weapon,language,spell,physical,trade} */
...
/* returns the skill of the language passed in int. */
