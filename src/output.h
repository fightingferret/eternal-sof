...
void    send              ( char_data*, const char* );
void    send              ( link_data*, const char* );
void    switched_send     ( char_data*, const char* );  /* PUIOK 28/12/1999 */
