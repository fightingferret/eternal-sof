...
class Char_Data : public Thing_Data
{
 public: 
  ...
  /* Nutrition added zemus mar 10 */
  int               nutrition;
  
  int                presleep; /* ADDED Smith - 3-5-2000 */
  ...
  bool Seen       ( char_data* );
  bool Too_Dark   ( char_data* );  /* PUIOK 24/1/2000 */
...
class Wizard_Data : public player_data
{
 public:
  ...
  note_data*     descdata_edit;  /* PUIOK 25/3/2000 */
  int             dd_last_seen;  /* PUIOK 25/3/2000 */
